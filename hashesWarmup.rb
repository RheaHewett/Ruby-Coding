...
=end
training=Hash.new
training["monday"]=["Woodward"]
training["tuesday"]= ["Skiing","weightlifting"]
training["wednesday"]= ["Skiing", "Recovery workout"]
training["thursday"]= ["Skiing", "Recovery workout"]
training["friday"]= ["Skiing after school"]
training["saturday"]=["skiing", "walk the dogs"]
training["sunday"]= ["skiing", "walk the dogs"]
